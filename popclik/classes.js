...
class Campo {
  constructor(padre,mrc_id,etq_id,etq_txt,cmp_id,cmp_clase,cmp_tipo,cmp_size,cmp_maxlength,cmp_alignment) {
    ...
    this.cmp_alignment = cmp_alignment;
    ...
    field.style.textAlign = this.cmp_alignment;

    marco.appendChild(label);
    marco.appendChild(field);
    console.log(this);
    document.getElementById(this.padre).appendChild(marco);
  }
}
